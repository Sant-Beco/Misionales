...
class Usuario(Base):
    ...
    cedula         = Column(String(12), unique=True, index=True, nullable=False)  # identificador único de login
    nombre         = Column(String(100), nullable=True)                           # nombre real (opcional)
    nombre_visible = Column(String(150), nullable=True)                           # nombre para mostrar en UI
